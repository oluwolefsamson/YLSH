...
const statusConfig = {
  registered: { label: 'Confirmed', color: 'bg-blue-100 text-[#082F49] border-blue-200', icon: CheckCircle },
                ...
                <div key={reg._id} className="rounded-2xl border border-slate-200/18 overflow-hidden">
                  <div className="p-4 md:p-5 flex items-start gap-4 flex-wrap">
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      {showQR && (
                        <button onClick={() => setExpandedId(isExpanded ? null : reg._id)} className="px-4 py-1.5 rounded-full bg-primary text-white text-sm font-semibold hover:bg-[#061e35] transition-colors">
