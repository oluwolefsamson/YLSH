...
const MentorEventsPage: NextPageWithLayout = () => {
  ...
  return (
    <div>
      <PageHeader eyebrow="Events" title="Events & Sessions" subtitle="Browse and register for upcoming YLSH events. Your QR codes appear in My Registrations." icon={<CalendarCheck size={14} />} />
                ...
                <div key={event._id} className="flex flex-col p-5 rounded-xl border border-slate-200/18">
                  ...
                  <div className="flex flex-col gap-1.5 mb-4">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <span className="text-sm text-muted-foreground">{new Date(event.date).toLocaleDateString('en-NG', { month: 'short', day: 'numeric', year: 'numeric' })}</span>
...
MentorEventsPage.getLayout = (page) => <MentorLayout>{page}</MentorLayout>
