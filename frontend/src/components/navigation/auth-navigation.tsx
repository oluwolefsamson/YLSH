...
const AuthNavigation: FC = () => {
  return (
    <div className="flex gap-3">
      <NextLink
        href="/signin"
        className="inline-flex items-center justify-center px-5 py-2 border-2 border-primary text-primary font-semibold text-sm tracking-wide hover:bg-primary/10 transition-colors"
      >
        Sign In
      </NextLink>
      <NextLink
